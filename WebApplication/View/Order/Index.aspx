<%@ Page Title="" Language="C#" MasterPageFile="~/View/Index.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="WebApplication.View.Order.Index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <h4>
            <asp:HyperLink ID="HyperLink1" href="/View/Order/Cart.aspx" runat="server">See Cart!</asp:HyperLink>
        </h4>
    </div>
    <br /><br />
    <div>
